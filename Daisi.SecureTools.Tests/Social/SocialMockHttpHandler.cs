...
/// <summary>
/// Mock HTTP message handler for testing social media API calls.
/// Supports queuing multiple responses for multi-step API flows.
/// </summary>
public class SocialMockHttpHandler : HttpMessageHandler
{
    ...
    public SocialMockHttpHandler(string responseContent, HttpStatusCode statusCode = HttpStatusCode.OK)
    {
        _responses.Enqueue((responseContent, statusCode));
    }

    public SocialMockHttpHandler(params (string Content, HttpStatusCode StatusCode)[] responses)
    {
