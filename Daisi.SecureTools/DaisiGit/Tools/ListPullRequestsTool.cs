...
/// <summary>
/// List pull requests in a repository, optionally filtered by status.
/// </summary>
public class ListPullRequestsTool(DaisiGitClient client) : IToolExecutor
{
    public async Task<ExecuteResponse> ExecuteAsync(string baseUrl, string sessionId, List<ParameterValue> parameters)
    {
        ...
        return new ExecuteResponse
        {
            ...
            OutputMessage = $"Listed pull requests in {owner}/{repo}"
        };
    }
}
